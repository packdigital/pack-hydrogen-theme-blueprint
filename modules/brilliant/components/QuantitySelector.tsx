  ...
  return (
    ...
    >
      <Button
        ...
        className={`relative size-10 rounded-md border border-border transition disabled:opacity-50 ${
      ...
      <Button
        ...
        className={`relative size-10 rounded-md border border-border transition disabled:opacity-50 md:hover:border-neutralLight ${
          hideButtons ? 'invisible' : ''
        } ${
          disableIncrement
            ? 'cursor-not-allowed'

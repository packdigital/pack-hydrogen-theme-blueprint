...
import type {UseDesktopMenuReturn} from '~/components/Header/useDesktopMenu';
import type {UseMobileMenuReturn} from '~/components/Header/useMobileMenu';
  ...
  ({
    ...
    return (
      ...
      >
              ...
              {navItems?.map((item, index) => {
                ...
                return (
                  <li key={index} className="flex">
                    ...
                    >
                      <h5 className="text-lg font-medium text-white text-shadow">
                        {item.navItem?.text}
                      </h5>
        ...
        <div className="order-3 flex items-center justify-end gap-4 text-white text-shadow md:gap-5">
          <button

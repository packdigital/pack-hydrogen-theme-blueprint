...
import type {BYOPQuickShopOptionProps} from './BYOPProductItem.types';

export function BYOPQuickShopOption({
...
BYOPQuickShopOption.displayName = 'BYOPQuickShopOption';
